    ...
    >
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardText}>
          In the game “The Lord Of Balls”, each player has their own heart and a
          progress bar. The heart constantly changes color – your task is to tap only when it shines
          in your color: for an Angel – purple, for a Demon – green. Each accurate touch adds points to
